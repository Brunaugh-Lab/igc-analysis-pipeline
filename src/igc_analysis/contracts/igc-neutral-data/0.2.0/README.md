...
- `examples/synthetic_dispersive_profile/` is a deterministic homologous-series fixture generated by `scripts/generate_synthetic_dispersive_fixture.py`. It has a known 40.0 mJ/m² dispersive profile, nonzero pressure correction, and asymmetric probe peaks.
